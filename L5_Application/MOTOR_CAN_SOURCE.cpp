...
void canTransmitReceiver::Receive_init()
{

    CAN_init(can1, 500, 1000, 1000, *BusOffCb,*DataOverCanBuffer);/*Initializing CAN bus*/
...
void canTransmitReceiver::Receiver_message(void)
{
    can_msg_t rx_msg;
...
bool canTransmitReceiver::init(void)
{
    //Transmit_init();
    Receive_init();
    return true;
